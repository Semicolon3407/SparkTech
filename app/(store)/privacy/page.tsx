  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="max-w-3xl mx-auto prose prose-lg prose-primary prose-headings:font-extrabold prose-headings:tracking-tight prose-p:text-gray-600 prose-p:font-medium">
        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-gray-950 mb-10">Privacy Policy</h1>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-extrabold text-gray-950 tracking-tight mt-12 mb-6">1. Introduction</h2>
          <p>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-extrabold text-gray-950 tracking-tight mt-12 mb-6">2. Data We Collect</h2>
          <p>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-extrabold text-gray-950 tracking-tight mt-12 mb-6">3. Use of Your Information</h2>
          <p>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-extrabold text-gray-950 tracking-tight mt-12 mb-6">4. Security</h2>
          <p>
        ...
        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 mt-20">
          <h3 className="text-xl font-extrabold text-gray-950 tracking-tight mb-4">Questions?</h3>
