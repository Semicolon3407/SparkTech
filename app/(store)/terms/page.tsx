  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="max-w-3xl mx-auto prose prose-lg prose-primary prose-headings:font-black prose-headings:tracking-tight prose-p:text-gray-600 prose-p:font-medium">
        <h1 className="text-4xl md:text-5xl font-black tracking-tight text-gray-950 mb-10">Terms & Conditions</h1>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-black text-gray-950 tracking-tight mt-12 mb-6">1. General Terms</h2>
          <p>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-black text-gray-950 tracking-tight mt-12 mb-6">2. Product Availability</h2>
          <p>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-black text-gray-950 tracking-tight mt-12 mb-6">3. Payment</h2>
          <p>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-black text-gray-950 tracking-tight mt-12 mb-6">4. Limitation of Liability</h2>
          <p>
        ...
        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 mt-20">
          <h3 className="text-xl font-black text-gray-950 tracking-tight mb-4">Agreement</h3>
